...
- **Jazon — Lyzr's AI SDR** · Core contributor. Multi-agent system that contributed to **$1.2M+ ARR**. Launched on Product Hunt.
- **Enterprise risk assessment for a Fortune 500 IT services firm** · 85%+ classification accuracy · SLA 82% → 91% · ~$150–200K annual savings
- **Voice AI for US healthcare outreach** · Twilio + hybrid TTS · sub-second latency · 60% API cost reduction · $2–4M pipeline impact
- **Multi-agent content platform** · 90% time reduction (5 hrs → 10 min per workflow)
- **The Cliff News** · Next.js web + React Native mobile with AI-generated article summaries · live on App Store, Play Store, and web

---

### Stack I use daily

**AI / LLM** — OpenAI · Anthropic · Azure OpenAI · multi-agent orchestration · RAG · ChromaDB · Pinecone · Qdrant · prompt engineering · eval pipelines

**Backend** — Python · FastAPI · Django · Node.js · PostgreSQL · MongoDB · Redis · Azure MSSQL

**Frontend & Mobile** — React · Next.js · TypeScript · Tailwind · React Native · Expo

**Voice & Real-time** — Twilio · WebSockets · SSE · TTS/STT pipelines

**Cloud & Infra** — AWS (Lambda, ECS, EC2, Amplify, S3) · Azure · Docker · CI/CD

---

### How I work

I take ownership of the problem, not just the ticket. If the approach has a gap, I flag it early and propose a better one. Production-first, clean architecture, no surprise scope, no silent delays.

**Currently open to:** freelance, contract, and contract-to-hire engagements focused on production AI systems.

---

### Reach me

🌐 [Upwork](https://www.upwork.com/freelancers/anupamp19) · 💼 [LinkedIn](https://www.linkedin.com/in/anupam-parashar/) · 🐦 [Twitter/X](https://twitter.com/anuparashar0507)

📩 Open with the problem — if I'm the right fit I'll tell you exactly how I'd solve it, what it costs, and the timeline. If I'm not, I'll tell you that too.
...
<div align="center">
	...
	<code><img width="50" src="https://raw.githubusercontent.com/marwin1991/profile-technology-icons/refs/heads/main/icons/prisma.png" alt="Prisma" title="Prisma"/></code>
